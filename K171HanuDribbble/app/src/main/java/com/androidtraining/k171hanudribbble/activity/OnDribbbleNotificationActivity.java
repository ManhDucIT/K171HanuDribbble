...
import com.androidtraining.k171hanudribbble.adapter.OnDribbleListNotificationsAdapter;
import com.androidtraining.k171hanudribbble.models.NotificationItem;

import java.util.ArrayList;
import java.util.List;

public class OnDribbbleNotificationActivity extends BaseActivity {
    ...
    private Toolbar toolbar_onDribbble_notification_screen;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ondribbble_notification);
        bindData();
        reflection();

        setSupportActionBar(toolbar_onDribbble_notification_screen);
        toolbar_onDribbble_notification_screen.setNavigationOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(OnDribbbleNotificationActivity.this, SettingActivity.class);
    ...
    private void reflection() {
        ...
        adapter = new OnDribbleListNotificationsAdapter((List<NotificationItem>) listOptions, this);
        lst_option = findViewById(R.id.lst_notifications);
        lst_option.setAdapter(adapter);
        lst_option.setLayoutManager(layoutManager);

        toolbar_onDribbble_notification_screen = findViewById(R.id.toolbar_onDribbble_notification_screen);
    }
