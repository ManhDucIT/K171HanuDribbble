package com.androidtraining.k171hanudribbble.adapter;
...
public class OnPhoneListNotificationAdapter extends RecyclerView.Adapter {
    private List<NotificationItem> lstoptions;
    private Context context;

    public OnPhoneListNotificationAdapter(List<NotificationItem> lstoptions, Context context) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
        ...
        public void onClick(View view) {
            reverseSwitch(switchCompat);
        }

        public void reverseSwitch(SwitchCompat switchCompat) {
